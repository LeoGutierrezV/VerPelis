...
import { SeriesService } from '../../_service/series.service';
        ...
        <div class="hero-content">
          <div class="hero-info">
            ...
            <div class="meta-info">
              ...
              <span>{{ series.numberOfEpisodes }} episodios</span>
              <span>{{ series.numberOfSeasons }} temporadas</span>
              <span class="rating">
        ...
        <mat-tab-group>
          ...
          <mat-tab label="Información">
            <div class="info-content">
              <div class="info-section">
                ...
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    ...
                    <span class="value">{{ series.numberOfSeasons }}</span>
                  </div>
                  <div class="info-item">
                    <span class="label">Episodios</span>
                    <span class="value">{{ series.numberOfEpisodes }}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="info-section" *ngIf="series.cast?.length">
                <h3>Reparto</h3>
                <div class="creators">
                  <div *ngFor="let actor of series.cast" class="creator">
